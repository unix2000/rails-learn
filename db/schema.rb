...
ActiveRecord::Schema.define(version: 20161106125446) do
  ...
  create_table "items", force: :cascade, options: "ENGINE=MyISAM DEFAULT CHARSET=utf8" do |t|
    t.string   "name",              limit: 60,               null: false
    t.integer  "types_id",                      default: 0
    t.string   "email",             limit: 60,               null: false
    t.string   "address",           limit: 180, default: "", null: false
